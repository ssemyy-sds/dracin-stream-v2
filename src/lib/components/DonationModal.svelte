<script lang="ts">
  ...
  const fallbackQr = 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://saweria.co/dracin';
...
{#if isOpen}
  ...
  >
    <!-- Modal -->
    <div class="relative w-full max-w-sm bg-gradient-to-b from-brand-gray to-brand-dark rounded-2xl overflow-hidden shadow-2xl animate-scale-in">
      <!-- Close Button -->
      <button 
        onclick={onClose}
      ...
      <div class="p-6 pb-4 text-center border-b border-white/10">
        <div class="inline-flex items-center justify-center w-14 h-14 rounded-full bg-brand-orange/20 mb-4">
      ...
      <div class="p-6 flex flex-col items-center">
        <div class="relative bg-white p-4 rounded-xl shadow-inner">
          <img 
            src={imageError ? fallbackQr : qrisImage}
            alt="QRIS Code"
